...
When proposing or weighing-in on any issue or pull request, consider the [Code of Conduct](https://github.com/lottie/lottie-spec/blob/main/Code_of_Conduct.md) to better understand expected and unacceptable behavior.
